		...
		<div class="page-margin">
			<div class="uk-grid-collapse" uk-grid>
				...
				<div class="uk-width-1-3@m">
					<div id="info-right" style="color: white; background-color: var(--black)">
						<div class="Smallmont"
							style="font-weight: 700; font-size: 20px;line-height: 1.7; margin-top:63px; margin-bottom: 30px; text-align: center; color: white">
