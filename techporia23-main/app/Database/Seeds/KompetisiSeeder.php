...
class KompetisiSeeder extends Seeder
{
    public function run()
    {
        ...
        ['id_kompetisi' => 6, 'nama_kompetisi' => 'Lukis'], // Added Painting competition
        ['id_kompetisi' => 7, 'nama_kompetisi' => 'Tari'],    // Added Dance competition
        ['id_kompetisi' => 8, 'nama_kompetisi' => 'Band'],       ];
